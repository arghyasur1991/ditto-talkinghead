...
def main():
    ...
    print("\nYou can now use these configs with:")
    ...
    print("\nNote: Some ONNX models may have compatibility issues on Mac ARM.")
    print("If you encounter GridSample3D operator errors, this is a known limitation.")
    print("The system will automatically fall back to CPU-only execution.")
